...
# %% auto 0
__all__ = ['colab_train_dir', 'colab_test_dir', 'local_train_dir', 'local_test_dir', 'colab_is_true', 'get_file_lists',
           'extract_text', 'label_func', 'get_difference', 'get_fnames_dict', 'get_data_dict', 'get_fnames_dls_dict',
           'get_resnet_encoder', 'create_model']

# %% ../nbs/cancer_dataloading.ipynb 3
def colab_is_true():
